// Shared source of truth for the SEO city landing pages.
// Used by components/SeoCityPage.tsx (rendering) and scripts/generate-sitemap.mjs
// (sitemap.xml generation) so both always stay in sync when a city/service is
