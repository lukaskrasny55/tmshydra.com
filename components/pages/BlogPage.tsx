...
export const BlogPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="bg-slate-900 py-20 sm:py-24 text-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <h1 className="text-4xl sm:text-6xl font-black tracking-tighter mb-6 uppercase leading-[0.95]">
        ...
        <div className="grid grid-cols-1 gap-8">
          {blogPosts.map((post) => (
            <Link
              ...
              className="group bg-white rounded-[2rem] shadow-lg border border-slate-100 p-8 sm:p-10 hover:shadow-2xl hover:-translate-y-1 transition-all block"
            >
