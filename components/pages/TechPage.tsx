...
export const TechPage: React.FC<Props> = ({ onBack }) => {
  const [roofCompositions] = useState([
    {
    ...
    },
    {
      ...
      subtitle:
        'Tento typ strechy - extenzívna zelená strecha, nie je určený na aktívne využívanie, ide však o najľahšiu a najlacnejšiu variantu vegetačnej strechy.',
      image: 't2.jpg',
      layers: [
    ...
    {
      title: 'POCHÔDZNA STRECHA',
      subtitle:
        'Skladba vrstiev pochôdznej strechy s dlažbou na rektifikačných terčoch:',
      image: 't3.jpg',
      layers: [
