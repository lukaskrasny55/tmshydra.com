...
import { ArrowRight, ShieldCheck, Users, Award, MapPin } from 'lucide-react';
          ...
          <div className="mb-12 lg:mb-0 flex flex-col gap-4 max-w-full">
            ...
            <div className="mt-8 space-y-6">
              <h3 className="text-xl font-bold uppercase tracking-tight text-white flex items-center gap-3">
                Prečo si vybrať <span className="text-blue-500">nás?</span>
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6">
                <div className="flex gap-4 group">
                  <div className="flex-shrink-0 w-12 h-12 bg-blue-600/10 rounded-xl flex items-center justify-center border border-blue-500/20 group-hover:border-blue-500/50 transition-colors">
                    <ShieldCheck className="w-6 h-6 text-blue-500" />
                  </div>
                  <div>
                    <h4 className="font-bold text-white uppercase text-sm tracking-wide">Kvalitné materiály</h4>
                    <p className="text-slate-400 text-xs leading-relaxed mt-1">Používame iba overené materiály od renomovaných výrobcov.</p>
                  </div>
                </div>
                <div className="flex gap-4 group">
                  <div className="flex-shrink-0 w-12 h-12 bg-blue-600/10 rounded-xl flex items-center justify-center border border-blue-500/20 group-hover:border-blue-500/50 transition-colors">
                  ...
                  <div>
                    <h4 className="font-bold text-white uppercase text-sm tracking-wide">Skúsený tím</h4>
                    <p className="text-slate-400 text-xs leading-relaxed mt-1">Odborní pracovníci s dlhoročnou praxou v oblasti hydroizolácií.</p>
                  </div>
                </div>
                <div className="flex gap-4 group">
                  <div className="flex-shrink-0 w-12 h-12 bg-blue-600/10 rounded-xl flex items-center justify-center border border-blue-500/20 group-hover:border-blue-500/50 transition-colors">
                  ...
                  <div>
                    <h4 className="font-bold text-white uppercase text-sm tracking-wide">Záruka a istota</h4>
                    <p className="text-slate-400 text-xs leading-relaxed mt-1">Na naše práce a materiály poskytujeme záruku 2 - 15 rokov.</p>
                  </div>
                </div>
                <div className="flex gap-4 group">
                  <div className="flex-shrink-0 w-12 h-12 bg-blue-600/10 rounded-xl flex items-center justify-center border border-blue-500/20 group-hover:border-blue-500/50 transition-colors">
                  ...
                  <div>
                    <h4 className="font-bold text-white uppercase text-sm tracking-wide">Pôsobíme po celom SR</h4>
                    <p className="text-slate-400 text-xs leading-relaxed mt-1">Spoľahlivo prídeme kamkoľvek nás potrebujete.</p>
                  </div>
                </div>
              </div>
            </div>
